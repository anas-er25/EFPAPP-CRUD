...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO employes (id, nom, prenom, age) VALUES ('$num', '$nom', '$prenom', '$age')";
    $result = mysqli_query($cnx, $query);
    if ($result) {
        echo "<script>alert('Employé ajouté avec succès');</script>";
    } else {
        echo "<script>alert('Erreur lors de l\'ajout de l\'employé');</script>";
    }
}
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $res = mysqli_query($cnx, "select * from employe;");
